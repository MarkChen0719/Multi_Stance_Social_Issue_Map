                ...
                <div class="solution-card">
                    ...
                    <div class="solution-card-content">
                        ...
                        <div class="platform-role">
                            <h4>本平台如何協助改善這項問題</h4>
                            <ul>
                                <li>利用文字探勘分析與「高租金」高度共現的關鍵字（青年、北部、低薪等），呈現結構性租金壓力來源。</li>
                                <li>透過網路圖視覺化租金議題的核心群集，協助使用者理解租金問題不是單點事件，而是系統性問題。</li>
                                <li>提供可回溯的資料來源，使租金議題討論更透明，避免情緒性或偏誤資訊主導。</li>
                                <li>作為政策討論之證據基礎，有助於評估補貼、社宅、租金監測等政策的必要性與方向。</li>
                            </ul>
                        </div>
                    </div>
                </div>
                ...
                <div class="solution-card">
                    ...
                    <div class="solution-card-content">
                        ...
                        <div class="platform-role">
                            <h4>本平台如何協助改善這項問題</h4>
                            <ul>
                                <li>自動偵測與租屋糾紛高度相關的關鍵詞（押金不退、違建、不簽約等），協助使用者辨識高風險情境。</li>
                                <li>將黑心條款與糾紛案例轉為可視化群集，使使用者理解問題集中在哪些類型的物件與條件。</li>
                                <li>未來可加入簡易版租屋風險檢測工具（貼上文案→系統標註危險字），降低資訊不對稱。</li>
                                <li>提供原始資料回溯功能，使糾紛案例與風險警示具有證據依據。</li>
                            </ul>
                        </div>
                    </div>
                </div>
                ...
                <div class="solution-card">
                    ...
                    <div class="solution-card-content">
                        ...
                        <div class="platform-role">
                            <h4>本平台如何協助改善這項問題</h4>
                            <ul>
                                <li>將「不租學生／不租移工／不租外國人」等排除條件從零碎案例統整為可視化議題群。</li>
                                <li>顯示弱勢排除議題與社會住宅、包租代管、補貼政策的連動關係，協助理解政策缺口。</li>
                                <li>讓使用者了解弱勢租屋困境的結構性成因，而不再以個人偏見來看待問題。</li>
                                <li>提供可回溯的資料案例，使歧視問題的討論不再是抽象指控，而是有證據支持。</li>
                            </ul>
                        </div>
                    </div>
                </div>
                ...
                <div class="solution-card">
                    ...
                    <div class="solution-card-content">
                        ...
                        <div class="platform-role">
                            <h4>本平台如何協助改善這項問題</h4>
                            <ul>
                                <li>使用文字探勘比對民眾常見問題與政策條文，使法規與真實需求產生連結。</li>
                                <li>將法規相關的討論（如押金、修繕責任、漲租規範）結構化呈現，降低法條理解難度。</li>
                                <li>讓使用者透過議題地圖快速理解政策適用情境，而不是被大量資訊淹沒。</li>
                                <li>協助學生與民眾辨識自己「符合哪些政策」、「需要找哪些管道」，提升可用性。</li>
                            </ul>
                        </div>
                    </div>
                </div>
